        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        <form id="becomeCaregiverForm" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            {{-- <div class="form-group">
                                <label for="becomeCaregiverMainImage">Edit becomeCaregiver Image</label>
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input form-control" name="becomeCaregiverMainImage" id="becomeCaregiverMainImage" accept=".png, .jpg, .jpeg">
            ...
            $.ajax({
                ...
                success:function(response){
                    if(response.status == 1){
                        ...
                        $("#becomeCaregiverForm").trigger("reset");
                    }else{
