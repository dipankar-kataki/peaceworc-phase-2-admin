                ...
                <div class="d-flex">
                    <div class="my-auto">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" id="user" class="mr-4 ht-60 wd-60 my-auto primary">
                            ...
                            <path fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="16" d="M30.989,215.99064a112.03731,112.03731,0,0,1,194.02311.002"></path>
                        </svg>
                    </div>
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
        <div class="card  overflow-hidden project-card">
            <div class="card-body">
                <div class="d-flex">
                    <div class="my-auto">
                        <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 64 64" id="building" class="mr-4 ht-60 wd-60 my-auto danger">
            ...
            <div class="card-body">
                <div class="d-flex">
                    <div class="my-auto">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" id="job-application" enable-background="new 0 0 477.849 477.849" class="mr-4 ht-60 wd-60 my-auto success" version="1.1">
                            <path fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="10" d="M210.45 377.16 45 481.33 9 504V216l36 28.8 23.51 18.81 20.37 16.29z"></path>
                            <path fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="10" d="M45 216v28.8L9 216zM504 216l-36 28.68V216zM45 185.89V216H9zM504 216h-36v-30.11z"></path><path fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="10" d="M45 216v28.8L9 216zM504 216l-36 28.68V216zM504 504H9l36-22.67 165.45-104.17 33.32-20.98a22.996 22.996 0 0 1 24.47-.02l33.49 21L468 481.43 504 504z"></path>
                            <path fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="10" d="M504 216v288l-36-22.57-166.27-104.27L468 244.68z"></path><path fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="10" d="M468 9v235.68L301.73 377.16l-33.49-21a22.996 22.996 0 0 0-24.47.02l-33.32 20.98L88.88 279.9l-20.37-16.29L45 244.8V9h423z"></path>
                            <circle cx="391.5" cy="85.5" r="49.5" fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="10"></circle>
                            <path fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="10" d="m363.656 85.5 18.563 18.562 37.125-37.124"></path>
                            <circle cx="76.5" cy="58.5" r="13.5" fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="10"></circle>
                            <circle cx="76.5" cy="112.5" r="13.5" fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="10"></circle>
                            <circle cx="76.5" cy="166.5" r="13.5" fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="10"></circle>
                            <circle cx="76.5" cy="220.5" r="13.5" fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="10"></circle>
                            <path fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="10" d="M108 63h207M108 117h207M108 171h207M108 225h207M108 279h207M90 274.5c0 1.92-.4 3.75-1.12 5.4l-20.37-16.29c2.24-1.64 5-2.61 7.99-2.61 7.46 0 13.5 6.04 13.5 13.5z"></path>
                        </svg>
                    </div>
                    <div class="project-content">
                        <h6>Jobs</h6>
